(function (global, factory) {
  ...
  var O2_AMBIENT_CLASSNAME = "o2_ambient_".concat(id);
  ...
  function () {
    function AmbientBase() {
      classCallCheck(this, AmbientBase);
    }

    createClass(AmbientBase, [{
      key: "initDOM",
      value: function initDOM() {
        ...
        canvas.style.left = '0';
        canvas.style.top = '0';
        canvas.style.width = "".concat(this.width / devicePixelRatio, "px");
        canvas.style.height = "".concat(this.height / devicePixelRatio, "px");
  ...
  var Snow =
  /*#__PURE__*/
  function (_AmbientBase) {
    inherits(Snow, _AmbientBase);
    ...
    function Snow() {
      ...
      _this = possibleConstructorReturn(this, getPrototypeOf(Snow).call(this));
      _this.devicePixelRatio = getDevicePixelRatio();
      _this.isPaused = false;
      _this.isInited = false;
      _this.durCounter = 0;
      _this.timestamp = 0;
      _this.isStopAdding = false;
    ...
    createClass(Snow, [{
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 4;
                  return this.preloadTextures();

                case 4:
                  this.preloader = _context.sent;
                  this.textures = map_1(this.texturesURL, function (url) {
                    return _this2.preloader.get(url);
                  });
                  this.setTexureCache();
      ...
      value: function reset() {
        ...
        this.FPS = 30;
        this.texturesURL = values_1(filter_1(window[O2_AMBIENT_CONFIG].textures, function (texture) {
          return trim_1(texture).length !== 0;
        }));
      ...
      value: function setTexureCache() {
        ...
        this.textures.forEach(function (img, index) {
          _this3.offWidth += img.width;
          _this3.offHeight = Math.max(img.height, _this3.offHeight || 0);
          maxSize = Math.max(_this3.offHeight, img.width);
        });
        ...
        this.textures.forEach(function (img, index) {
          ...
          _this3.offCtx.drawImage(img, x, y, img.width, img.height);
      ...
      key: "windowResizeHandle",
      value: function windowResizeHandle(e) {
        var devicePixelRatio = this.devicePixelRatio;
        this.width = window.innerWidth * devicePixelRatio;
        this.height = window.innerHeight * devicePixelRatio;
        this.canvas.width = this.width;
        this.canvas.height = this.height;
        this.canvas.style.width = "".concat(this.width / devicePixelRatio, "px");
        this.canvas.style.height = "".concat(this.height / devicePixelRatio, "px");
      }
    }, {
      key: "addParticles",
      value: function addParticles() {
        ...
        for (var i = 0; i < this.particleNumber; i++) {
          var imgIndex = getRandomInt(0, this.textures.length - 1);
          var radius = (this.isTexture ? this.imgsSize[imgIndex].width : getRandom(2, maxRadius)) * (this.devicePixelRatio / 2);
          particles.push({
      ...
      value: function drawTexture() {
        ...
        this.particles.forEach(function (particle) {
          var size = _this4.imgsSize[particle.imgIndex];
          var width = size.width;
          var height = size.height;
          ctx.save();
          ctx.translate(particle.x + width / 2, particle.y + height / 2);
          ctx.rotate(degToRad(particle.rotate));
          ctx.drawImage(_this4.offCanvas, size.x, size.y, width, height, -width / 2, -height / 2, particle.r, particle.r);
          ctx.restore();
        });
      }
    }, {
      ...
      value: function drawDefault() {
        ...
        this.particles.forEach(function (particle, index) {
          ...
          ctx.fillStyle = "rgba(255, 255, 255, ".concat(particle.opacity, ")");
          ctx.fill();
        });
      }
    }, {
      key: "loop",
      value: function loop(ts) {
        var _this5 = this;
        ...
        var clockcounter = now - this.timestamp;
        ...
        if (elapsed > this.INTERVAL) {
          ...
          this.draw();
          var isSnowInViewport = !this.isStopAdding;
          this.particles.forEach(function (particle, index) {
            if (particle.y + particle.r * 2 < 0 && _this5.isStopAdding) return;
            particle.x += Math.cos(particle.a) * particle.offsetX;
            particle.a += particle.aStep;
            particle.y += particle.speed;

            if (particle.y >= _this5.height && !_this5.isStopAdding) {
              particle.y = -_this5.maxRadius;
              particle.x = getRandomInt(0, _this5.width);
            }

            if (particle.y + particle.r * 2 >= 0 && particle.y < _this5.height) {
      ...
      value: function endCallback() {
        var endCallback = window[O2_AMBIENT_CONFIG].endCallback;
        typeof endCallback === 'function' && endCallback();

        if (typeof endCallback === 'string') {
          try {
            eval("(".concat(decodeURI(endCallback), ")()"));
          } catch (e) {}
        }
      }
    }]);
  ...
  var snow1 = '//storage.jd.com/o2images/snow-01.png';
  var snow2 = '//storage.jd.com/o2images/snow-02.png';
  var snow3 = '//storage.jd.com/o2images/snow-03.png';
  var snow4 = '//storage.jd.com/o2images/snow-04.png';
  window[O2_AMBIENT_CONFIG] = {
    particleNumber: 60,
    textures: [snow1, snow2, snow3, snow3, snow3, snow3, snow3, snow4],
    duration: 0,
    endCallback: encodeURI(function () {
      console.log('雪花落完了');
    }.toString())
  };
